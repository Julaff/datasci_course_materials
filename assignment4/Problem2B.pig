...
-- store the results in the folder /user/hadoop/Problem2B
store histogram into '/user/hadoop/Problem2B' using PigStorage();
-- Alternatively, you can store the results in S3, see instructions:
-- store count_by_subject_ordered into 's3n://superman/Problem2B';
